...
exports.addRatingAndReview = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    const ratingAndReview = await ratingAndReview_1.default.create({
        user: id,
        rating,
        review,
        course: courseId,
...
exports.getAverageRating = (0, asyncHandler_1.default)(async (req, res) => {
    const { courseId } = req.params;
    if (!courseId) {
        throw new apiError_1.ApiError({
            status: constant_1.HTTP_STATUS.NOT_FOUND,
    ...
    const result = await course_1.default.aggregate(pipeline);
    if (result.length === 0) {
        throw new apiError_1.ApiError({
            status: constant_1.HTTP_STATUS.NOT_FOUND,
...
exports.getAllRatingByCourse = (0, asyncHandler_1.default)(async (req, res) => {
    const { courseId } = req.params;
    if (!courseId) {
        throw new apiError_1.ApiError({
            status: constant_1.HTTP_STATUS.NOT_FOUND,
    ...
    const ratingAndReviews = await ratingAndReview_1.default.find({ course: courseId })
